...
public class PoolObject
{
    ...
    private PoolObject(PoolableObject Prefab, int Size)
    {
        this.Prefab = Prefab;
        this.Size = Size;
    ...
    public static PoolObject CreateInstance(PoolableObject Prefab, int Size)
    {
        PoolObject pool = new PoolObject(Prefab, Size);
